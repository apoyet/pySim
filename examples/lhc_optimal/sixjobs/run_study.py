...
# folder of study (TO BE CHECKED)

myStudyFolder = '/afs/cern.ch/work/a/apoyet/first_example/lhc_optimal/'
...
myEnvParam = {}
myEnvParam.update({
    '%MASKED_workspace' : 'lhc_optimal',
    '%MASKED_basedir' : '/afs/cern.ch/work/a/apoyet/first_example',
...
# Define the scans (TO BE CHECKED)
...
for current in IW:
    for distance in d:
        ...
        # Define the parameters (mask) (TO BE CHECKED)
